...
def spectr_to_spatial(qr, size_WM):
    ...
    qr_back[shift + 1:shift + 66, shift + 1:shift + 33] = qr[:, :32]
    for i in range(65):
        for j in range(32):
    ...
    qr_back[shift+1:shift+66, -shift-33:-shift] = qr[:, 32:]
...
# img1.save(r"data/spatial_spectr_in_shift_100_wm_65.png")
#
# qr_spatal = io.imread("data/spatial_spectr_in_shift_100_wm_65.png")
#
# check_qr = check_spatial2spectr(qr_spatal)
# img2 = Image.fromarray(check_qr.astype('uint8'))
# img2.save(r"data/check_ifft_wm_shift_100.png")
