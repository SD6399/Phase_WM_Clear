...
plt.plot(np.arange(9, 100, 10), ampl1, label="A = 1")
plt.plot(np.arange(9, 100, 10), ampl2, label="A = 2")
plt.plot(np.arange(9, 100, 10), ampl3, label="A = 3")
...
plt.title("зависимость от амплитуды", fontsize=20)
plt.show()
